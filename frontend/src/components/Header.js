        ...
        <header className="bg-gray-800 p-4 text-center flex justify-between items-center">
            ...
            <ul className='flex justify-center gap-4'>
                <li className="text-white">
                    <Link href="/pages/upload_request" className='flex items-center text-white hover:text-gray-300'>
                        <FolderMinusIcon className="h-5 w-5 inline-block mr-2" />
                        Agregar Solicitud
                    </Link>
                </li>
                <li className="text-white">
                    <Link href="/pages/upload_policy" className='flex items-center text-white hover:text-gray-300'>
                        <ArrowUpTrayIcon className="h-5 w-5 inline-block mr-2" />
                        Cargar Polizas
                    </Link>
                </li>
                <li className="text-white">
                    <Link href="/pages/upload_statement" className='flex items-center text-white hover:text-gray-300'>
                        <BuildingLibraryIcon className="h-5 w-5 inline-block mr-2" />
                        Cargar estado de cuenta
                    </Link>
                </li>
                <li className="text-white">
                    <Link href="/pages/statements" className='flex items-center text-white hover:text-gray-300'>
                        <ChartBarIcon className="h-5 w-5 inline-block mr-2" />
                        Estados de cuenta
                    </Link>
                </li>
                <li className="text-white">
                    <Link href="/pages/edit_user" className='flex items-center text-white hover:text-gray-300'>
